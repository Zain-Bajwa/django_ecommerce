    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='authentication.category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductReview',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(default=0)),
                ('date_created', models.DateField(default=datetime.datetime.today)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='authentication.order')),
